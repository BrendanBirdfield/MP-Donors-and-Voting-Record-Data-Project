...
data gathered via Webscraping and API calls
...
Once processed, this data was then exported as a csv and imported into power 2 main pages were created. The first allows searching for specific mps or political parties and specific vote categroies using a slicers. These slicers connect to a bar graph of sentiment allowing comparison of voting sentiment between indiviual mp's and or political parties.
